    ...
    <div className="flex-container">
        ...
        <div className='imageFundo2'>
            ...
            <div className='divContainer5'>
                <div className='divContainer6' onClick={() => {stopTimer(); startTimerTwo();}}>
                    <div className='circulo'>
                        <p className='p23'>A</p>
                    </div>
                    <p className='p24' >Entre <b>6 mil e 10 mil</b> por milímetro cúbico de sangue.</p>
                </div>
                <div className='divContainer7' onClick={() => {stopTimer(); startTimerTwo();}}>
                    <div className='circulo'>
                        <p className='p23'>A</p>
                    </div>
                    <p className='p24'>Entre <b>400 e 100</b> por milímetro cúbico de sangue.</p>
                </div>
                <div className='divContainer8' onClick={() => {stopTimer(); startTimerTwo();}}>
                    <div className='circulo'>
                        <p className='p23'>A</p>
                    </div>
